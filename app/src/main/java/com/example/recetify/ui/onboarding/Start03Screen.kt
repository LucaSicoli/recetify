...
@Composable
fun Start03Screen(navController: NavHostController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(32.dp),
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            Text(
                text = "Cocina fácil y sin complicaciones",
                fontSize = 20.sp,
            ...
            Text(
                text = "Cada receta tiene instrucciones claras e ingredientes exactos para que cocinar sea simple y divertido.",
                fontSize = 14.sp,
